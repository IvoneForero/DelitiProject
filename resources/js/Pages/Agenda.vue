                        ...
                        <table class="min-w-max w-full table-auto">
                            <thead>
                                <tr class="bg-pink-100 text-pink-900 uppercase text-sm leading-normal">
                                    <th class="py-3 px-6 text-left">HORARIO ENTREGA</th>
                                    <th class="py-3 px-6 text-left">ESTADO</th>
                                    <th class="py-3 px-6 text-left">ACCIÓN</th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600 text-sm font-light">
                                <tr v-for="(object, index) in calendar" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center w-24">
                                        <div class="flex item-left justify-left">
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" title="Ver">
