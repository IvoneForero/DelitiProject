                    ...
                    <div class="bg-white shadow-md rounded my-6" v-if="modal==false">
                        <table class="min-w-max w-full table-auto">
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                <tr v-for="(object, index) in categoria" :key="index" class="border-b border-blue-100 hover:bg-gray-100">
                        ...
                        <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
                            ...
                            <div class="flex flex-col px-6 py-5 bg-gray-50">
                                <div class="mb-3 space-y-2 w-full">
                                    ...
                                    <input placeholder="Ingrese Categoria" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border border-gray-300 rounded text-gray-600 h-10 pl-5 pr-10" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                <div class="mb-3 space-y-2 w-full">
                                    <label class="text-pink-700 select-none font-medium">Descripción</label>
                                    <textarea p-5 mb-5 placeholder="Ingrese descripción de la Categoría" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border border-gray-300 rounded text-gray-600 h-10 pl-5 pr-10" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    </textarea>
                                </div>                                
                                <label for="default" class="text-pink-700 select-none font-medium">Seleccione un estado</label>
