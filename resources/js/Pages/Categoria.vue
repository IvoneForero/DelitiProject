                        ...
                        <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
                            ...
                            <div class="flex flex-col px-6 py-5 bg-pink-50">
                                ...
                                <div class="mb-3 space-y-2 w-full">
                                    ...
                                    <textarea v-model="desc" p-5 mb-5 placeholder="Ingrese descripción de la Categoría" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border border-gray-300 rounded text-gray-600 h-10 pl-5 pr-10" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    </textarea>
                                </div>                                
        ...
        methods:
        {
            ...
            update()
            {
                ...
                axios.put(url, {
                    ...
                    description:this.desc.toUpperCase(),
                    state:this.edo
                })
                .then(function(response) {
                    me.listarDatos();     
